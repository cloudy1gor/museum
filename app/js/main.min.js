...
$((function(){$(".banner").slick({dots:!0,prevArrow:'<button type="button" class="slick-prev"><img src="../images/src/slide-prev.svg" alt="#"></button>',nextArrow:'<button type="button" class="slick-next"><img src="../images/src/slide-next.svg" alt="#"></button>',responsive:[{breakpoint:1300,settings:{prevArrow:!1,nextArrow:!1}}]}),$(".gallery__slider").slick({dots:!1,infinite:!0,speed:300,slidesToShow:1,centerMode:!0,variableWidth:!0,prevArrow:'<button type="button" class="slick-prev"><img src="../images/src/slide-prev.svg" alt="#"></button>',nextArrow:'<button type="button" class="slick-next"><img src="../images/src/slide-next.svg" alt="#"></button>'}),$(".partners__slider").slick({dots:!1,infinite:!0,speed:300,slidesToShow:5,variableWidth:!0,prevArrow:'<button type="button" class="slick-prev"><img src="../images/src/slide-prev.svg" alt="#"></button>',nextArrow:'<button type="button" class="slick-next"><img src="../images/src/slide-next.svg" alt="#"></button>'}),$(".menu a, .footer__link").on("click",(function(t){t.preventDefault();var s=$(this).attr("href"),e=$(s).offset().top;$("body,html").animate({scrollTop:e},1500)})),$(".menu__btn, .menu a").on("click",(function(){$(".menu__list").toggleClass("menu__list--active")}))})),$(window).scroll((function(){$(this).scrollTop()>1?$(".menu").addClass("sticky"):$(".menu").removeClass("sticky")}));